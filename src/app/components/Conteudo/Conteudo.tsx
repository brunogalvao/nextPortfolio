      ...
      <div className="content-wrapper">
        ...
        >
          <Anchor
            ...
            className="h-20 backdrop-blur-md bg-white/30 flex items-center p-4 hover:!text-red-600"
            items={[
              {
                key: 'Home',
                href: '#Home',
        ...
        <section id="Home">
          ...
          sint laborum, inventore consectetur perferendis nulla deserunt tempore
          voluptatum, magnam incidunt mollitia libero quod fugiat dolorum
          recusandae pariatur! Ab, voluptatem.
        </section>
